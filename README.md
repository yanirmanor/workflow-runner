...
<a href="https://github.com/yanirmanor/workflow-runner/releases/latest/download/workflow-runner-arm64.dmg">
...
Or grab the [zip](https://github.com/yanirmanor/workflow-runner/releases/latest/download/workflow-runner-darwin-arm64.zip) instead. Browse all releases on the [Releases](../../releases/latest) page.
